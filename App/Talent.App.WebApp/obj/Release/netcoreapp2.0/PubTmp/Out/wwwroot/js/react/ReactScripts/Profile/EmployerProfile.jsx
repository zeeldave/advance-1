...
export default class EmployeeProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: 'http://competitiontask1profile.azurewebsites.net/profile/profile/getEmployerProfile',
    ...
    saveData() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://competitiontask1profile.azurewebsites.net/profile/profile/saveEmployerProfile',
